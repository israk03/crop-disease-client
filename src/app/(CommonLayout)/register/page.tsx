...
import { Leaf, ShieldAlert, Users, CloudSun } from "lucide-react";

export const metadata: Metadata = {
  title: "Create Account | Crop Disease Platform",
  description: "Join our AI-powered agricultural intelligence platform to protect and optimize your yields.",
};

export default function RegisterPage() {
  return (
    <main className="min-h-screen grid lg:grid-cols-12 bg-background select-none">
      {/* Left Column: Platform Branding & Value Propositions */}
        ...
        <div className="relative z-10 my-auto space-y-8 max-w-sm">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tight leading-tight">
              Protect your yield with real-time analytics.
            </h2>
            <p className="text-emerald-300/80 text-sm">
              Deploying computer vision models instantly to intercept diseases before they spread.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold">AI Image Diagnostic</h4>
                <p className="text-xs text-emerald-300/70">Upload leaf snapshots for instantaneous pathology assessment.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold">Verified Agronomists</h4>
                <p className="text-xs text-emerald-300/70">Consult dedicated agricultural experts on complex infestations.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold">Microclimate Advisories</h4>
                <p className="text-xs text-emerald-300/70">Hyper-localized risk forecasting driven by real-time weather streams.</p>
              </div>
            </div>
          </div>
        </div>
